...
void main() {
  ...
  test('sendMessage with ReplyMarkup (InlineKeyboardButton) works', () async {
    ...
    expect(message.replyMarkup.inlineKeyboard.length, equals(2));
    expect(message.replyMarkup.inlineKeyboard[0][0].text, equals('Button 1'));
    expect(message.replyMarkup.inlineKeyboard[0][0].callbackData, equals('btn1'));
  }, skip: false);
  ...
  test('sendMessage with ReplyMarkup (ReplyKeyboardMarkup) with mixed buttons types works', () async {
    var buttons = [
      ...
      [
        KeyboardButton.RequestPoll('Poll (Quitz)', KeyboardButtonPollType(PollType.QUIZ)),
        KeyboardButton.RequestPoll('Poll (Regular)', KeyboardButtonPollType(PollType.REGULAR))
      ]
    ];
